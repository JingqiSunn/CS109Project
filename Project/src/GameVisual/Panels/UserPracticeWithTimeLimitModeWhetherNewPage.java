...
public class UserPracticeWithTimeLimitModeWhetherNewPage extends JPanel {
    ...
    public UserPracticeWithTimeLimitModeWhetherNewPage(Dimension screenSize, User user) {
        this.user = user;
        this.setLayout(null);
